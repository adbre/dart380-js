...
EditMessage.prototype.openEdit = function (message) {
...
EditMessage.prototype.onKeyPress = function (e) {
    ...
    if (e.key === 'SLT') {
        ...
        var pos = this._message.nextWriteableCell(this._row, this._getCursor(), 1);
        this._row = pos.row;
        this._setCursor(pos.col);
        this.update();
        return true;
        ...
        this.write(' ');
        var pos = this._message.nextWriteableCell(this._row, cursor, -1);
        this._row = pos.row;
        this._setCursor(pos.col);
        this.update();
        return true;
